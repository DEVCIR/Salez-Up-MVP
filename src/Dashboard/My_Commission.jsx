                    ...
                    <div className="flex w-auto gap-4">
                        <div className="flex-1 bg-white p-4 rounded-2xl shadow-lg">
                            ...
                            <div className="flex justify-between items-center mt-4">
                                ...
                                <p className="text-mm text-[#5F5E5E]">vs {totalCommission - lastMonthCommission < 0 ? '-' + currency : currency}{Math.abs((totalCommission - lastMonthCommission).toFixed(2))} last month</p>
                            </div>
